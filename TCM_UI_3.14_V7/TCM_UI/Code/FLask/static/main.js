...
function openModal(imageSrc) {
    ...
    document.getElementById('modalImg').src = imageSrc + timestamp;
...
document.getElementById('GUI').addEventListener('click', function() {
    ...
    fetch('/run_python_GUI', { method: 'POST' })
});

document.getElementById('问卷1').addEventListener('click', function() {
    // 设置要跳转的URL
    window.location.href = 'questionnaire1.html';
});

document.getElementById('问卷2').addEventListener('click', function() {
    // 设置要跳转的URL
    window.location.href = 'questionnaire2.html';
});

document.getElementById('问卷3').addEventListener('click', function() {
    // 设置要跳转的URL
    window.location.href = 'questionnaire3.html';
});

document.getElementById('问卷4').addEventListener('click', function() {
    // 设置要跳转的URL
